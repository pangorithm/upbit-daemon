...
CREATE TABLE tickers_y2026m05d01 PARTITION OF tickers FOR VALUES FROM ('20260501') TO ('20260502');
...
CREATE TABLE trades_y2026m05d01 PARTITION OF trades FOR VALUES FROM ('2026-05-01') TO ('2026-05-02');
...
CREATE TABLE candles_seconds_y2026m05d01 PARTITION OF candles_seconds FOR VALUES FROM ('2026-05-01T00:00:00') TO ('2026-05-02T00:00:00');
